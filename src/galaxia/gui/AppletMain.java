...
public class AppletMain extends JApplet
  implements TimerInterface, ControlPanelListener
{
  ...
  private JLabel _lblGeneration;
  private JLabel _lblStarCount;
  ...
  private JInternalFrame frmControlPanel;
  private JInternalFrame frmGalaxyPanel;
  private JInternalFrame frmInformation;
  ...
  public void init()
  {
    ...
    _oGalaxy = new Galaxy();
    _oGalaxyProperties = new GalaxyProperties();
    _oGalaxy.setProperties(_oGalaxyProperties);

    _oGalaxyPanel = new GalaxyPanel();
    _oGalaxyPanel.setGalaxy(_oGalaxy);

    frmGalaxyPanel.add(_oGalaxyPanel);
    _oGalaxyPanel.setBounds(0, 0, 400, 400);

    _oControlPanelListener = this;
  ...
  private void initComponents()
  {
    ...
    frmInformation = new JInternalFrame();
    _lblStarCount = new JLabel();
    _lblGeneration = new JLabel();
    frmControlPanel = new JInternalFrame();
    pnlZoom = new JPanel();
    ...
    frmGalaxyPanel = new JInternalFrame();

    getContentPane().setLayout(new GridLayout(1, 0));

    dsk.setVerifyInputWhenFocusTarget(false);

    frmInformation.setTitle("Información");
    frmInformation.setVisible(true);
    frmInformation.getContentPane().setLayout(null);

    _lblStarCount.setText("Cantidad de Estrellas");
    frmInformation.getContentPane().add(_lblStarCount);
    _lblStarCount.setBounds(10, 10, 250, 14);

    _lblGeneration.setText("Generación");
    frmInformation.getContentPane().add(_lblGeneration);
    _lblGeneration.setBounds(10, 40, 240, 14);

    frmInformation.setBounds(10, 590, 290, 110);
    dsk.add(frmInformation, JLayeredPane.DEFAULT_LAYER);

    frmControlPanel.setTitle("Panel de Configuración");
    ...
    txtZoom.setModel(new SpinnerNumberModel(100, 50, 500, 5));
    txtZoom.addChangeListener(new ChangeListener() {
      public void stateChanged(ChangeEvent evt) {
        AppletMain.this.txtZoomStateChanged(evt);
      }
    });
    pnlZoom.add(txtZoom);
    ...
    optGuiStarSizeOne.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent evt) {
        AppletMain.this.optGuiStarSizeOneActionPerformed(evt);
      }
    });
    pnlZoom.add(optGuiStarSizeOne);
    optGuiStarSizeOne.setBounds(20, 40, 220, 23);

    frmControlPanel.getContentPane().add(pnlZoom);
    pnlZoom.setBounds(10, 460, 270, 70);
    ...
    btnAction_AdvanceOne.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent evt) {
        AppletMain.this.btnAction_AdvanceOneActionPerformed(evt);
      }
    });
    btnAction_AdvanceMany.setText("Avanzar X generaciones");
    btnAction_AdvanceMany.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent evt) {
        AppletMain.this.btnAction_AdvanceManyActionPerformed(evt);
      }
    });
    ...
    txtAction_Interval.addChangeListener(new ChangeListener() {
      public void stateChanged(ChangeEvent evt) {
        AppletMain.this.txtAction_Interval_StateChanged(evt);
      }
    });
    ...
    frmControlPanel.getContentPane().add(pnlAction);
    pnlAction.setBounds(10, 290, 270, 170);
    ...
    txtGrowth_GrowRate.addChangeListener(new ChangeListener() {
      public void stateChanged(ChangeEvent evt) {
        AppletMain.this.txtGrowth_GrowRate_StateChanged(evt);
      }
    });
    ...
    optGrowth_Grow.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent evt) {
        AppletMain.this.optGrowth_GrowActionPerformed(evt);
      }
    });
    ...
    frmControlPanel.getContentPane().add(pnlGrowth);
    pnlGrowth.setBounds(10, 210, 270, 80);
    ...
    txtRotation_MovementCount.addChangeListener(new ChangeListener() {
      public void stateChanged(ChangeEvent evt) {
        AppletMain.this.txtRotation_MovementCountStateChanged(evt);
      }
    });
    ...
    txtRotation_MovementLag.addChangeListener(new ChangeListener() {
      public void stateChanged(ChangeEvent evt) {
        AppletMain.this.txtRotation_MovementLagStateChanged(evt);
      }
    });
    optRotation_Rotate.setText("Rotar");
    optRotation_Rotate.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent evt) {
        AppletMain.this.optRotation_RotateActionPerformed(evt);
      }
    });
    ...
    frmControlPanel.getContentPane().add(pnlRotation);
    pnlRotation.setBounds(10, 110, 270, 100);

    pnlCreation.setBorder(BorderFactory.createTitledBorder("Crear nueva galaxia"));
    ...
    txtAction_StarCount.addChangeListener(new ChangeListener() {
      public void stateChanged(ChangeEvent evt) {
        AppletMain.this.txtAction_StarCount_StateChanged(evt);
      }
    });
    ...
    txtAction_Distribution.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent evt) {
        AppletMain.this.txtAction_DistributionActionPerformed(evt);
      }
    });
    ...
    btnAction_Initialize.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent evt) {
        AppletMain.this.btnAction_InitializeActionPerformed(evt);
      }
    });
    pnlCreation.add(btnAction_Initialize);
    btnAction_Initialize.setBounds(90, 70, 83, 23);

    frmControlPanel.getContentPane().add(pnlCreation);
    pnlCreation.setBounds(10, 10, 270, 100);

    frmControlPanel.setBounds(10, 10, 300, 570);
    dsk.add(frmControlPanel, JLayeredPane.DEFAULT_LAYER);

    frmGalaxyPanel.setResizable(true);
    frmGalaxyPanel.setTitle("Simulación");
    frmGalaxyPanel.setVisible(true);
    frmGalaxyPanel.getContentPane().setLayout(new GridLayout(1, 0));
    frmGalaxyPanel.setBounds(320, 10, 490, 520);
    dsk.add(frmGalaxyPanel, JLayeredPane.DEFAULT_LAYER);
